...
country_avg = FOREACH grouped GENERATE group AS country, AVG(clean.total_price_usd) AS avg_order_value;
STORE country_avg INTO '/ecommerce/output/pig/AvgOrderValueByCountry' USING PigStorage(',');