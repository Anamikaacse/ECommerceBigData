...
grouped = GROUP clean BY category;
cat_summary = FOREACH grouped GENERATE group AS category, COUNT(clean) AS order_count, SUM(clean.total_price_usd) AS total_sales;
STORE cat_summary INTO '/ecommerce/output/pig/analysis3' USING PigStorage(',');