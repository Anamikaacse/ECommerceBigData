...
grouped = GROUP clean BY country;
country_revenue = FOREACH grouped GENERATE group AS country, SUM(clean.total_price_usd) AS total_revenue;
country_sorted = ORDER country_revenue BY total_revenue DESC;
top10_countries = LIMIT country_sorted 10;
STORE top10_countries INTO '/ecommerce/output/pig/Top10CountriesByRevenue' USING PigStorage(',');